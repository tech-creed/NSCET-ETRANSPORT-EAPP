...
> {
  ...
  var FacultyList = [];
  final userRef = FirebaseDatabase.instance.ref('students');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: getAppbar(context, "Assign Student", isLogout: true),
        ...
        body: StreamBuilder(
            ...
            builder: (context, AsyncSnapshot<DatabaseEvent> snapshot) {
              ...
              if (snapshot.hasData &&
                ...
                List<DropdownMenuItem<Object>> studentList = [];

                studentList.clear();

                map.forEach(
                  (key, value) {
                    studentList.add(DropdownMenuItem(
